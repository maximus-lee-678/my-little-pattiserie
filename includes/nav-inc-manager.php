    ...
    <div class="container-sm">
        ...
        <div class="collapse navbar-collapse" id='navbarList'>
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a href="./view-all-products.php" class="nav-link pt-3 mr-2">View All Products</a>
                </li>

                <li class="nav-item">
                    <a href="./staff-overview.php" class="nav-link pt-3 mr-2">Staff Details</a>
                </li>

                <li class="nav-item">
                    <a href="./analytics.php" class="nav-link pt-3 mr-2">Sales Analysis</a>
                </li>
