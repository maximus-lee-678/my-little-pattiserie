...
<html lang="en">
    <head>
        ...
        <!-- JS -->
        <script defer src="./assets/js/orders-historic.js"></script>
    ...
    <body>
        ...
        <div style="display:flex; flex-wrap:wrap; align-items:center; justify-content: space-evenly;">
            <div>
                <a class="btn btn-secondary" id="view-orders" href="order-overview.php">View Current Orders</a>
            </div>
            <div>
        ...
        <div id="table-contents" style="padding:35px; overflow-x:auto;">
            ...
            <table class="table table-sm" style="border-style:solid;">
                <tr>
                    <th scope="col"><button class="btn btn-light table-top" id="table-top-collect_date">Collect Date<i class="bi bi-arrow-up"></i></button></th>
